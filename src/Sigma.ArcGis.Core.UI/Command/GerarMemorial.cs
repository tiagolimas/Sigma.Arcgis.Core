...
using Sigma.Arcgis.Core.UI.Forms.Memorial;

namespace Sigma.Arcgis.Core.UI.Command
{
    /// <summary>
    /// Command that works in ArcMap/Map/PageLayout
    /// </summary>
    [Guid("dae6d711-e517-4cf6-a2ac-475564665548")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("Sigma.ArcGis.Core.UI.Command.GerarMemorial")]
    public sealed class GerarMemorial : BaseCommand
    {
